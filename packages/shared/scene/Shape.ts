...
import { assertNever, isLinearElement } from "../element/typeChecks";
import { ROUGHNESS } from "../constants";
import { isTransparent } from "../utils";
import { getCornerRadius, isPathALoop } from "../math";
import { getArrowheadPoints, getDiamondPoints } from "../element/bounds";
...
export const generateElementShape = (
  ...
  opts?: { isExporting: boolean; canvasBackgroundColor: string },
): Drawable | Drawable[] | null => {
  const generator = new RoughGenerator();
  const { isExporting = false, canvasBackgroundColor = "#fff" } = opts || {};
